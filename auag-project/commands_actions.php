...
<html lang="en">
    ...
    <head >
        ...
        <script src="view/js/command_action.js"></script>
                ...
                <div class="panel with-nav-tabs panel-primary">
                    <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li role="presentation" ><a href="commands.php">View SMS commands</a></li>
                            <li role="presentation" class="active"><a href="commands_actions.php">Command actions</a></li>
                        </ul>
                    </div>
                    <div class="panel-body">
                        <fieldset>
                            <legend>Manage command actions</legend>
                            <div id="container">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="text-left">Actions</h4>
                                        </div>
                                        <div class="panel-body text-left">
                                            <div id="actionstable"></div>
                                            <div id="membercolumn" hidden></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
