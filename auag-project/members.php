...
<html lang="en">
    <head >
        ...
        <script src="view/js/members.js"></script>
                ...
                <div class="panel with-nav-tabs panel-primary">
                    <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li role="presentation" class="active"><a href="members.php">View member</a></li>
                            <li role="presentation" ><a href="members_import.php">Import member info</a></li>
                        </ul>
                    </div>
